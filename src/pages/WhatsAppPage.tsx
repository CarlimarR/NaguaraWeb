  ...
  return (
    <div className="min-h-screen gradient-bg">
      <div className="container mx-auto px-4 py-6">
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-white bg-white/10 px-4 py-2 rounded-full hover:bg-white/20 transition-all hover:-translate-x-1 mb-8"
        >
        ...
        <div className="text-center text-white mb-12">
          ...
          <p className="text-xl opacity-90">Selecciona el número al que deseas escribir:</p>
        </div>
          ...
          <div className="space-y-6 mb-12">
            {whatsAppNumbers.map((item) => (
              <div 
                ...
                className="bg-white rounded-2xl p-6 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-2xl border-2 border-transparent hover:border-whatsapp group"
              >
                <div className="flex items-center gap-4 flex-wrap md:flex-nowrap">
                  <div className="text-5xl">{item.emoji}</div>
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-800 mb-1">{item.label}</h3>
                    <p className="text-whatsapp font-semibold text-lg">{item.number}</p>
                    <p className="text-gray-600 text-sm">{item.description}</p>
                  </div>
                  <div className="bg-whatsapp text-white px-4 py-2 rounded-xl flex items-center gap-2 group-hover:bg-whatsapp-dark transition-all group-hover:scale-105">
                    <FaWhatsapp />
                    <span>Escribir</span>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6">
              <div className="flex items-center gap-2 mb-3">
                <FaClock className="text-whatsapp text-xl" />
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6">
              <div className="flex items-center gap-2 mb-3">
                <FaLightbulb className="text-whatsapp text-xl" />
